...
public class Statistics implements Cloneable {
    ...
    Statistics(Statistics obj) {
        this.inMsgs.set(obj.inMsgs.get());
        this.outMsgs.set(obj.outMsgs.get());
        this.inBytes.set(obj.inBytes.get());
        this.outBytes.set(obj.outBytes.get());
        this.reconnects.set(obj.reconnects.get());
        this.flushes.set(obj.flushes.get());
    }
